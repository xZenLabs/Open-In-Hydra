...
A userscript to open Reddit links in the Hydra app on iPhone.

Enhanced search engine integration so Reddit links on search result pages (Google, Bing, etc.) open directly in Hydra without redirecting to Reddit first.
